    ...
    def get_moves_attack(self):
        ...
        for sq in combat_squares_1:
            if (sq.strength > sq.production) and (sq.move == -1):
                ...
                unsafe_attack = []
                for n in sq.neighbors:
                    if self.enemy_strength_map[2, n.x, n.y] == 0 or self.safe_to_move[n.x, n.y] or sq.strength <= 40:
                    ...
                    elif self.safe_to_move[n.x, n.y] == 0 and n.owner == 0 and n.strength == 0 or sq.strength <= 40:
