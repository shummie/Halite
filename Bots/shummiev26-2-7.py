...
class GameMap:
    ...
    def get_best_moves(self):
        ...
        for square in cells_to_consider_moving:
            ...
            value_map += numpy.multiply(self.recover_map_enemy_smooth[4] + self.distance_map_no_decay[square.x, square.y], self.is_neutral_map - self.combat_zone_map)
