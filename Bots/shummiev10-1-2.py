...
late_game_production_self_factor = -0.15
late_game_production_neutral_factor = 1.25
late_game_production_enemy_factor = 4
late_game_production_influence_factor = 0.4 # Sample values are around 50-80
late_game_production_square_influence_factor = 30
late_game_prod_over_str_influence_factor = 50 # Sample values are around 0.5 - 1.0
late_game_prod_over_str_self_factor = 0
late_game_prod_over_str_neutral_factor = 1.25
late_game_prod_over_str_enemy_factor = 3
late_game_enemy_strength_0_influence_factor = 7
late_game_enemy_strength_1_influence_factor = 8 # Sample values around 4-20
late_game_enemy_strength_2_influence_factor = 3 # Sample values around 2-40
late_game_enemy_strength_3_influence_factor = 1 # Sample values around 2-50
late_game_enemy_territory_1 = 40
late_game_enemy_territory_2 = 25
late_game_enemy_territory_3 = 10
...
class GameMap:
    ...
    def find_nearest_enemy_direction(self, square):
        ...
        while not success and index < 4:
            success = square.move_to_target(self.get_target(square, dir_distance[index][0]), True)
            index += 1
...
class Square:
    ...
    def move_to_target(self, destination, through_friendly, can_reroute = True):
