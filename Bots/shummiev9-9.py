...
botname = "shummie v9.9"

production_decay = 0.5
production_influence_max_distance = 6
buildup_multiplier = 8
strength_buffer = 75
...
def game_loop():
    ...
    if numpy.sum(game_map.is_owner_map[game_map.my_id]) < (10*(game_map.width * game_map.height)**.5) / 30 and game_map.frame < (10*(game_map.width * game_map.height)**.5) / 4:
