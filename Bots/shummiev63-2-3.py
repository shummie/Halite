...
class Game:
    ...
    def create_dijkstra_maps(self):
        ...
        def get_cost_recov(cellnum):
            x = cellnum // h
            y = cellnum % h
            return self.strength_map_1[x, y] / (self.production_map_01[x, y] ** 1.25)
    ...
    def update_configs(self):
        ...
        self.buildup_multiplier += (self.distance_from_border > 1) * 2
    ...
    def update_value_production_map(self):
        ...
        for g in global_targets:
            if self.base_value_map[g.x, g.y] > 0.02:
                ...
                self.global_border_map[tx, ty] += self.base_value_map[g.x, g.y] / (self.dij_recov_distance_map[g.x, g.y, tx, ty] ** 1.1)
