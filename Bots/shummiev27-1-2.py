...
class Game:
    ...
    def get_moves_attack(self):
        ...
        #potential_targets.sort(key = lambda x: self.enemy_strength_map[1, x.x, x.y], reverse = True)
        ...
        combat_distance_matrix[combat_distance_matrix == 0] = 999
