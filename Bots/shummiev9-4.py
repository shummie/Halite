...
production_influence_factor = 0.75 # Sample values are around 50-80
production_square_influence_factor = 40
prod_over_str_influence_factor = 80 # Sample values are around 0.5 - 1.0
prod_over_str_self_factor = 0.2
prod_over_str_neutral_factor = 1.5
prod_over_str_enemy_factor = 5
enemy_strength_0_influence_factor = 14
enemy_strength_1_influence_factor = 12 # Sample values around 4-20
enemy_strength_2_influence_factor = 6 # Sample values around 2-40
enemy_strength_3_influence_factor = 2 # Sample values around 2-50
