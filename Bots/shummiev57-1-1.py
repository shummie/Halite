...
#        logging.debug("get other moves Frame: " + str(game.frame) + " : " + str(end - start))
    ...
    def get_moves_attack(self):
        ...
        for square in combat_squares:
            if (square.strength > square.production * (self.buildup_multiplier[square.x, square.y] + self.distance_from_combat_zone[square.x, square.y])) and ((square.x + square.y) % 2 == self.frame % 2) and square.move == -1 and square.moving_here == []:
