...
class Game:
    ...
    def update_configs(self):
        ...
        squares_owned = np.sum(self.is_owned_map)
        self.combat_radius = ((squares_owned / 3.1415) ** 0.5) / 2
        ...
        if self.percent_owned > 0.10:
            self.buildup_multiplier += 2 + (self.percent_owned / 0.05)
