...
class GameMap:
    ...
    def get_best_moves(self):
        ...
        for square in cells_to_consider_moving:
            ...
            value_map += numpy.multiply(self.recover_map[4] + self.smoothed_value_distance_map, self.is_neutral_map - self.combat_zone_map)
            value_map += numpy.multiply(self.smoothed_value_distance_map + 10, self.combat_zone_map)
