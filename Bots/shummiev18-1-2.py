...
class GameMap:
    ...
    def get_best_moves(self):
        ...
        # call nearby units to attack this square
        
        for square in itertools.chain.from_iterable(self.squares):
            if square.owner == self.my_id and self.distance_from_enemy[square.x, square.y] <= 4 and not self.inner_border_map[square.x, square.y] and square.strength > (square.production * buildup_multiplier) and (square.x + square.y) % 2 == self.frame % 2:
