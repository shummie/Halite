...
class Game:
    ...
    def update_configs(self):
        self.buildup_multiplier = np.minimum(np.maximum(self.production_map, 6), 6)
    ...
    def update_value_production_map(self):
        ...
        self.value_production_map = 1 / np.maximum(self.base_value_map + self.global_border_map * 0.5, 0.001)
