...
class GameMap:
    ...
    def get_best_moves(self):
        ...
        for square in cells_to_consider_moving:
            ...
            value_map += numpy.multiply(self.recover_map[5] + self.dij_recov_distance_map[square.x, square.y], self.is_neutral_map - self.combat_zone_map)
            value_map += numpy.multiply(self.dij_recov_distance_map[square.x, square.y] + 10, self.combat_zone_map)
