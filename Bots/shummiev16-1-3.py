...
late_game_buildup_multiplier = 5
...
late_game_enemy_territory_1 = 70
...
class GameMap:
    ...
    def update_heuristic_map_v2(self):
        ...
        # Add a bit of favor to enemy cells
        self.heuristic_map_2 += (self.is_enemy_map) * -2.0
        
        # Combat zones should also be favored for attacking
        self.heuristic_map_2 += (self.combat_zone_map) * -3.0
    ...
    def get_heuristic_2(self, square):
        ...
        heuristic_map = numpy.copy(self.heuristic_map_2)
        # Add the distance map for this square. Squares further away take more time to recover its values
        heuristic_map += self.distance_map_no_decay[square.x, square.y] ** 1.25
        ...
        heuristic_map += self.combat_zone_map * combat_zone_value
        
        
        # Ignore cells we currently own.
        heuristic_map += (self.is_owned_map) * 999
