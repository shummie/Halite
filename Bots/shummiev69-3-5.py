...
class Game:
    ...
    def mark_unsafe(self, source, sq):
        if self.distance_from_enemy[sq.x, sq.y] <= 2 and source.strength > 35:
            if self.enemy_strength_map[2, sq.x, sq.y] > 20:
                self.safe_to_move[sq.x, sq.y] = 0
        for n in sq.neighbors:
            ...
            for n2 in n.neighbors:
                if not (n2.owner == 0 and n2.strength > 0):
                    if self.distance_from_enemy[n2.x, n2.y] <= 2 and self.enemy_strength_map[2, n2.x, n2.y] > 20:
