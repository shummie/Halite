...
production_influence_factor = 0.15
production_square_influence_factor = 1
prod_over_str_influence_factor = 0.05
prod_over_str_self_factor = 0
prod_over_str_neutral_factor = 1
prod_over_str_enemy_factor = 0.5
enemy_strength_1_influence_factor = .6
enemy_strength_2_influence_factor = .1
enemy_strength_3_influence_factor = .02        
