    ...
    def get_moves_prepare_strength(self):
        ...
        if len(enemy_border_squares) > 0:
            ...
            for square in combat_squares:
                if (self.distance_from_border[square.x, square.y] > 1) and (square.strength > square.production * self.buildup_multiplier[square.x, square.y] + 2) and (square.parity == self.parity) and square.move == -1 and square.moving_here == []:
