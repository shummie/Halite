...
class GameMap:
    ...
    def get_best_moves(self):
        ...
        for square in cells_to_consider_moving:
            ...
            if numpy.sum(self.combat_zone_map) == 0:
                ...
                value_map += numpy.multiply(self.recover_map_enemy_smooth[6] + self.distance_map_no_decay[square.x, square.y] * 2, self.is_enemy_map)
            ...
            if self.inner_border_map[square.x, square.y] and square.strength > 0:
                square.move_to_target(target, False)
            elif self.inner_border_map[square.x, square.y] and square.strength > (square.production * buildup_multiplier) and (square.strength > 100 or (square.x + square.y) % 2 == self.frame % 2):
                square.move_to_target(target, False)
