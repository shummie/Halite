...
class GameMap:
    ...
    def go_to_border(self, square):
        ...
        self_index = square.x * self.width + square.y
        inner_border_squares = []
        for x in range(0, self.width):
            for y in range(0, self.height):
                if self.maps[self.frame].inner_border_map[x, y] == 1:
                    inner_border_squares.append(x * self.width + y)
        ...
        return square.move_to_target(self.squares[target_index // self.width, target_index % self.width], True)
...
class Square:
    ...
    def move_to_target(self, destination, through_friendly, dijkstra = True):
        ...
        if not dijkstra:
            return self.move_to_target_old(self, destination, through_friendly)
...
class Maps():
    ...
    def update_border_map(self):
        ...
        self.inner_border_map = numpy.multiply(self.border_map, self.is_owner_map[self.game_map.my_id])
